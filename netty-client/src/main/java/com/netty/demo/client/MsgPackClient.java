...
import com.netty.demo.handler.MsgPackClientHandler;
import com.netty.demo.handler.ObjectClientHandler;
import com.netty.demo.serial.MessagePackDecoder;
import com.netty.demo.serial.MessagePackEncoder;
        ...
        try {
            ...
            bootstrap.handler(new ChannelInitializer<SocketChannel>() {
                ...
                protected void initChannel(SocketChannel ch) throws Exception {
                    ...
                    ch.pipeline().addLast(new MessagePackEncoder()); // 解码
                    // 自定义程序处理逻辑
